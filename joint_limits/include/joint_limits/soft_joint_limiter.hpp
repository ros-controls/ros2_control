...
#ifndef JOINT_LIMITS__SOFT_JOINT_LIMITER_HPP
#define JOINT_LIMITS__SOFT_JOINT_LIMITER_HPP
...
class SoftJointLimiter : public JointLimiterInterface<JointLimitsStateDataType>
{
public:
  /** \brief Constructor */
  JOINT_LIMITS_PUBLIC SoftJointLimiter();
...
template <typename JointLimitsStateDataType>
SoftJointLimiter<JointLimitsStateDataType>::SoftJointLimiter()
...
#endif // JOINT_LIMITS__SOFT_JOINT_LIMITER_HPP
