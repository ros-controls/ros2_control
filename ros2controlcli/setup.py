...
ROS2 Control command  interface.""",
    ...
    entry_points={
        ...
        'ros2controlcli.verb': [
            ...
            'configure = ros2controlcli.verb.configure_controller:ConfigureControllerVerb',
            'load_configure = \
                ros2controlcli.verb.load_configure_controller:LoadConfigureControllerVerb',
            'load_start = ros2controlcli.verb.load_start_controller:LoadStartControllerVerb',
