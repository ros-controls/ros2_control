...
{
/// Base classes for implementation of a hardware interface.
/**
  ...
  *   Those interfaces are: HW_IF_POSITION, HW_IF_VELOCITY, HW_IF_ACCELERATION, and HW_IF_EFFORT.
  */
class ReadOnlyHardwareInterface : public rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface
{
public:
  ReadOnlyHardwareInterface()
  : lifecycle_state_(rclcpp_lifecycle::State(
      lifecycle_msgs::msg::State::PRIMARY_STATE_UNKNOWN, lifecycle_state_names::UNKNOWN))
  {
  }

  /// HardwareInterface copy constructor is actively deleted.
  /**
   ...
   */
  ReadOnlyHardwareInterface(const ReadOnlyHardwareInterface & other) = delete;

  ReadOnlyHardwareInterface(ReadOnlyHardwareInterface && other) = default;

  virtual ~ReadOnlyHardwareInterface() = default;
...
class ReadWriteHardwareInterface : public ReadOnlyHardwareInterface
{
public:
  ReadWriteHardwareInterface() : ReadOnlyHardwareInterface() {}
