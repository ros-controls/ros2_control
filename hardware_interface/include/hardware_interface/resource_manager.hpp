...
public:
  ...
  /// Add controllers' internal state interfaces to resource manager.
  /**
   * Interface for transferring management of internal state interfaces to resource manager.
  ...
  /// Get list of internal state interface of a controller.
  /**
   * Returns lists of stored internal state interfaces names for a controller.
   *
   * \param[in] controller_name for which list of state interface names is returned.
   * \returns list of reference interface names.
   */
  std::vector<std::string> get_controller_internal_state_interface_names(
    const std::string & controller_name);

  /// Add controller's internal state interfaces to available list.
  /**
   ...
   * controller's internal state interfaces can be used by another controllers in chained
   * architectures.
   *
   * \param[in] controller_name name of the controller which interfaces should become available.
   */
  void make_controller_internal_state_interfaces_available(const std::string & controller_name);

  /// Remove controller's internal state interface to available list.
  /**
   ...
   */
  void make_controller_internal_state_interfaces_unavailable(const std::string & controller_name);

  /// Remove controllers internal state interfaces from resource manager.
  /**
   * Remove internal state interfaces from resource manager, i.e., resource storage.
   ...
   */
  void remove_controller_internal_state_interfaces(const std::string & controller_name);
