...
TEST_F(ForceTorqueSensorTest, validate_all_with_custom_names)
{
  ...
  // validate the default interface_names_
  ASSERT_EQ(force_torque_sensor_->interface_names_[0], sensor_name_ + "/" + "force.x");
  ASSERT_EQ(force_torque_sensor_->interface_names_[1], sensor_name_ + "/" + "force.z");
  ASSERT_EQ(force_torque_sensor_->interface_names_[2], sensor_name_ + "/" + "torque.y");
  ASSERT_EQ(force_torque_sensor_->interface_names_[3], sensor_name_ + "/" + "torque.z");
  ...
  hardware_interface::StateInterface force_x{sensor_name_, interface_names[0], &force_values_[0]};
  hardware_interface::StateInterface force_z{sensor_name_, interface_names[1], &force_values_[2]};

  // assign values to torque.y and torque.z
  hardware_interface::StateInterface torque_y{sensor_name_, interface_names[2], &torque_values_[1]};
  hardware_interface::StateInterface torque_z{sensor_name_, interface_names[3], &torque_values_[2]};
