...
public:
  ...
  /// deprecated: Use the init(const controller_interface::ControllerInterfaceParams & params)
  /// method instead. This method will be removed in future ROS 2 releases.
  return_type init(
