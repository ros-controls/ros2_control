...
[[maybe_unused]]
[[deprecated("Use TEST_ACTUATOR_HARDWARE_PLUGIN_NAME instead of TEST_ACTUATOR_HARDWARE_CLASS_TYPE.")]]
 const std::string TEST_ACTUATOR_HARDWARE_CLASS_TYPE = "test_actuator";
...
[[maybe_unused]]
[[deprecated("Use TEST_SENSOR_HARDWARE_PLUGIN_NAME instead of TEST_SENSOR_HARDWARE_CLASS_TYPE.")]]
 const std::string TEST_SENSOR_HARDWARE_CLASS_TYPE = "test_sensor";
...
[[maybe_unused]]
[[deprecated("Use TEST_SYSTEM_HARDWARE_PLUGIN_NAME instead of TEST_SYSTEM_HARDWARE_CLASS_TYPE.")]]
 const std::string TEST_SYSTEM_HARDWARE_CLASS_TYPE = "test_system";
