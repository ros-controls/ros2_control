...
#ifndef ROS2_CONTROL_HARDWARE__SENSORS_VELOCITY_SENSOR_HPP_
#define ROS2_CONTROL_HARDWARE__SENSORS_VELOCITY_SENSOR_HPP_
...
class VelocitySensorHardware : public ros2_control_core_hardware::SensorHardware
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(VelocitySensorHardware);

  ROS2_CONTROL_HARDWARE_PUBLIC VelocitySensorHardware() = default;
...
#endif  // ROS2_CONTROL_HARDWARE__SENSORS_VELOCITY_SENSOR_HPP_
