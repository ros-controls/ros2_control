...
#ifndef ROS2_CONTROL_HARDWARE__ACTUATORS_VELOCITY_ACTUATOR_HPP_
#define ROS2_CONTROL_HARDWARE__ACTUATORS_VELOCITY_ACTUATOR_HPP_
...
class VelocityActuatorHardware : public ros2_control_core_hardware::ActuatorHardware
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(VelocityActuatorHardware);

  ROS2_CONTROL_HARDWARE_PUBLIC VelocityActuatorHardware() = default;
...
#endif  // ROS2_CONTROL_HARDWARE__ACTUATORS_VELOCITY_ACTUATOR_HPP_
