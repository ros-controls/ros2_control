...
#ifndef ROS2_CONTROL_HARDWARE__ACTUATORS_POSITION_ACTUATOR_HPP_
#define ROS2_CONTROL_HARDWARE__ACTUATORS_POSITION_ACTUATOR_HPP_
...
namespace ros2_control_hardware_actuators
{

class PositionActuatorHardware : public ros2_control_core_hardware::ActuatorHardware
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(PositionActuatorHardware);

  ROS2_CONTROL_HARDWARE_PUBLIC PositionActuatorHardware() = default;
...
#endif  // ROS2_CONTROL_HARDWARE__ACTUATORS_POSITION_ACTUATOR_HPP_
