...
using robot_control_components::parse_robot_from_urdf;

TEST_F(TestComponentParser, successfully_parse_valid_urdf_actuators)
{
  std::string urdf_to_test = urdf_xml_head_ + valid_urdf_ros2_control_actuators_only_ + urdf_xml_tail_;
...
{
  std::string urdf_to_test = urdf_xml_head_ + valid_urdf_ros2_control_actuators_sensors_ + urdf_xml_tail_;
  const auto robot_info = parse_robot_from_urdf(urdf_to_test);
