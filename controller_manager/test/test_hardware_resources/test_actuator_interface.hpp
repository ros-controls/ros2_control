...
#ifndef TEST_HARDWARE_RESOURCES__TEST_ACTUATOR_INTERFACE_HPP_
#define TEST_HARDWARE_RESOURCES__TEST_ACTUATOR_INTERFACE_HPP_

#include <memory>

#include "hardware_interface/actuator_hardware_interface.hpp"

class TestActuator : public hardware_interface::ActuatorHardwareInterface
{
public:
...
#endif  // TEST_HARDWARE_RESOURCES__TEST_ACTUATOR_INTERFACE_HPP_
