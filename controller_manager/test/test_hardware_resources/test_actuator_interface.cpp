...
#include "./test_actuator_interface.hpp"

hardware_interface::return_type
TestActuator::configure(const hardware_interface::HardwareInfo & actuator_info)
{
...
PLUGINLIB_EXPORT_CLASS(TestActuator, hardware_interface::ActuatorHardwareInterface)
