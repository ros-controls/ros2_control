  ...
  std::shared_ptr<controller_manager_msgs::srv::ListHardwareComponents::Response> response)
{
  ...
  for (const auto & [component_name, component_info] : hw_components_info)
  {
    ...
    component.class_type = component_info.plugin_name; // TODO: deprecated currently. Remove soon
    RCLCPP_WARN(get_logger(), "The 'class_type' field in 'controller_manager_msgs/msg/HardwareComponentState.msg' is deprecated and will be removed soon. Please switch over client code to use 'plugin_name' instead.");
