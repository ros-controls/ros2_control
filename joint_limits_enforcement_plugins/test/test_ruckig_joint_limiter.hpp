...
#ifndef TEST_RUCKIG_JOINT_LIMITER_HPP_
#define TEST_RUCKIG_JOINT_LIMITER_HPP_
...
class RuckigJointLimiterTest : public ::testing::Test
{
public:
  void SetUp() override
  {
  ...
  RuckigJointLimiterTest()
  : joint_limiter_type_("ruckig_joint_limiter/RuckigJointLimiter"),
...
#endif  // TEST_RUCKIG_JOINT_LIMITER_HPP_
